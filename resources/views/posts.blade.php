    ...
    <div class="py-4 px-4 mx-auto max-w-screen-xl lg:py-4 lg:px-0">
        <div class="grid gap-8 lg:grid-cols-3 md:grid-cols-2">
            @forelse ($posts as $post)
                <article
                    class="card-container p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                    <div class="card-content">
                        ...
                        <h2
                            class="title-clamp mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white hover:underline">
                            <a href="/posts/{{ $post['slug'] }}">{{ $post['title'] }}</a>
                        </h2>
                        <p class="body-clamp mb-5 font-light text-gray-500 dark:text-gray-400">{{ $post['body'] }}</p>
                    </div>
